...
// getPodsForService returns the list of pods matching the service's selector
func (r *defaultEndpointsResolver) getPodsForService(ctx context.Context, svc *corev1.Service) ([]corev1.Pod, error) {
